...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000F80u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x0016u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0xDDu);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW0, 0xD0u);
