...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\mux_v1_10"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\mux_v1_10\mux_v1_10.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\mux_v1_10"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\mux_v1_10\mux_v1_10.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__M1_C1_net;
	wire [0:0] tmpFB_0__M1_C1_net;
	wire [0:0] tmpIO_0__M1_C1_net;
	wire [0:0] tmpINTERRUPT_0__M1_C1_net;
	electrical [0:0] tmpSIOVREF__M1_C1_net;
	...
	cy_psoc3_pins_v1_10
		...
		M1_C1
		 (.oe(tmpOE__M1_C1_net),
		  .y({Net_1832}),
		  .fb({tmpFB_0__M1_C1_net[0:0]}),
		  .io({tmpIO_0__M1_C1_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_C1_net),
		  .interrupt({tmpINTERRUPT_0__M1_C1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_C1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M2_C1_net;
	wire [0:0] tmpFB_0__M2_C1_net;
	wire [0:0] tmpIO_0__M2_C1_net;
	wire [0:0] tmpINTERRUPT_0__M2_C1_net;
	electrical [0:0] tmpSIOVREF__M2_C1_net;
	...
	cy_psoc3_pins_v1_10
		...
		M2_C1
		 (.oe(tmpOE__M2_C1_net),
		  .y({Net_3236}),
		  .fb({tmpFB_0__M2_C1_net[0:0]}),
		  .io({tmpIO_0__M2_C1_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_C1_net),
		  .interrupt({tmpINTERRUPT_0__M2_C1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_C1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : RX_Mux
        reg  tmp__RX_Mux_reg;
        always @(Net_261 or Net_262 or Net_3437)
        begin
            case (Net_3437)
                1'b0 :  tmp__RX_Mux_reg = Net_261;
                1'b1 :  tmp__RX_Mux_reg = Net_262;
            endcase
        end
	...
	wire [0:0] tmpOE__Vo6_net;
	wire [0:0] tmpIO_0__Vo6_net;
	wire [0:0] tmpINTERRUPT_0__Vo6_net;
	electrical [0:0] tmpSIOVREF__Vo6_net;
	...
	cy_psoc3_pins_v1_10
		...
		Vo6
		 (.oe(tmpOE__Vo6_net),
		  .y({1'b0}),
		  .fb({Net_275}),
		  .io({tmpIO_0__Vo6_net[0:0]}),
		  .siovref(tmpSIOVREF__Vo6_net),
		  .interrupt({tmpINTERRUPT_0__Vo6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vo6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Vo5_net;
	wire [0:0] tmpIO_0__Vo5_net;
	wire [0:0] tmpINTERRUPT_0__Vo5_net;
	electrical [0:0] tmpSIOVREF__Vo5_net;
	...
	cy_psoc3_pins_v1_10
		...
		Vo5
		 (.oe(tmpOE__Vo5_net),
		  .y({1'b0}),
		  .fb({Net_278}),
		  .io({tmpIO_0__Vo5_net[0:0]}),
		  .siovref(tmpSIOVREF__Vo5_net),
		  .interrupt({tmpINTERRUPT_0__Vo5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vo5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Vo3_net;
	wire [0:0] tmpIO_0__Vo3_net;
	wire [0:0] tmpINTERRUPT_0__Vo3_net;
	electrical [0:0] tmpSIOVREF__Vo3_net;
	...
	cy_psoc3_pins_v1_10
		...
		Vo3
		 (.oe(tmpOE__Vo3_net),
		  .y({1'b0}),
		  .fb({Net_279}),
		  .io({tmpIO_0__Vo3_net[0:0]}),
		  .siovref(tmpSIOVREF__Vo3_net),
		  .interrupt({tmpINTERRUPT_0__Vo3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vo3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Vo4_net;
	wire [0:0] tmpIO_0__Vo4_net;
	wire [0:0] tmpINTERRUPT_0__Vo4_net;
	electrical [0:0] tmpSIOVREF__Vo4_net;
	...
	cy_psoc3_pins_v1_10
		...
		Vo4
		 (.oe(tmpOE__Vo4_net),
		  .y({1'b0}),
		  .fb({Net_280}),
		  .io({tmpIO_0__Vo4_net[0:0]}),
		  .siovref(tmpSIOVREF__Vo4_net),
		  .interrupt({tmpINTERRUPT_0__Vo4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vo4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
