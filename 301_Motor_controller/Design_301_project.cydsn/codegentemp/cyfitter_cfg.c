...
#define BS_UDB_1_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000940u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000A6Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000A74u)
